# sell-04-invoice-check

**Workflow:** P2P Straight-Sell Deal  
**Domain:** P2P Sell  
**Contract:** `sell-04-invoice-check: A → B | P`
...
invoice_total:           decimal   # total amount (subtotal + buyer_premium)
invoice_buyer_premium_pct: decimal # buyer premium percentage (5%)
invoice_subtotal:        decimal   # line item 1
...
1. **Buyer reviews invoice** — display line items: subtotal, buyer_premium, total
...
- [ ] invoice.subtotal unchanged (RULE_8)
